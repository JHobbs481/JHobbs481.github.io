...
I enabled **pfSense ISC DHCP daemon** for the subnets **LAN** and **Isolated** and disabled it on the **Active Directory** subnet as the domain controller will act as the DHCP server for this lab.
