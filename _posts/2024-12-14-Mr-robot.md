...
## Let's Begin!
To begin, I ran an nmap scan to find and scan any open ports on a range of IPs. Using [Virtualbox's Extension Pack](https://www.virtualbox.org/manual/ch08.html#vboxmanage-dhcpserver) to create a DHCP server I hosted the Mr. Robot and Kali linux VMs on an [Internal Network](https://www.virtualbox.org/manual/ch06.html#network_internal). Fortunately for me i knew the range of IPs.
